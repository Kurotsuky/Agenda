...
public class MenuPanel extends javax.swing.JPanel 
{
    ...
    public MenuPanel(AgendaForm controller) 
    {
    ...
    {//GEN-HEADEREND:event_btnSearchActionPerformed
        ...
        List<Contacto> matches = searcher.SearchContact(text, filter, AgendaForm.getAgenda().GetAgenda());
        updateList(matches);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        Contacto contacto =  contactList.get(listContactos.getSelectedIndex());
        
        AgendaForm.getAgenda().BorrarContacto(contacto);
        updateList();
    ...
    {
        JPanel contentPanel = controller.getPanelContent();
        ...
        controller.showPanel(AgendaForm.getUPDATE());
    }
    ...
    private void updateList() 
    {
        ...
        contactList = AgendaForm.getAgenda().GetAgenda();
        
        for (int i = 0; i < contactList.size(); i++) 
        {
            Contacto contacto = contactList.get(i);
